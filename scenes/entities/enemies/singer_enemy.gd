...
@export var bullet_emitter_1: BulletEmitter
...
func _ready() -> void:
	...
	if bullet_emitter_1 and bullet_emitter_2:
		if Globals.SECONDARY_COLOR_MAP.has(initial_color_id):
			bullet_emitter_1.color_id = Globals.SECONDARY_COLOR_MAP[initial_color_id][0]
			bullet_emitter_2.color_id = Globals.SECONDARY_COLOR_MAP[initial_color_id][1]
		else:
			bullet_emitter_1.color_id = initial_color_id
